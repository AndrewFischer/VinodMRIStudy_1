...
[window, ~] = Screen('OpenWindow', 0, [0 0 0], [0 0 1919 1200],32,2);

our_texture = Screen('MakeTexture', window, I);

Screen('FrameRect', window, [0 255 0],[700 300 900 500],5);

Screen('DrawTexture', window, our_texture, [0 0 1919 1200], [320 0 1919+320 1200]);
...
[window, window_size] = Screen('OpenWindow', 0, [0 0 0], [0 0 1919 1200],32,2);
...
Screen('DrawTexture', window, our_texture, [0 0 1546 949], [0 0 1919 1200]);
